      ...
      <Introduction>
        <ProfileCard>
          ...
          <div className="profile-text">
            ...
            <h1>Kaiden&nbsp;Kennedy</h1>
          </div>
        </ProfileCard>
        <div className="short">
        I'm currently completing a Software Engineering program at The University of South Florida and focused on expanding my experience as a Full-Stack Software Engineer. 
        </div>
        ...
        <Social>
          <div className="iconcontainer">
            <a
              className="same"
              href="https://github.com/kaidenkennedy7"
              target="_blank"
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="https://www.linkedin.com/in/kaidenkennedy/"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="iconcontainer">
            <a
              className="same"
              href="mailto:kaid.kennedy729@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
